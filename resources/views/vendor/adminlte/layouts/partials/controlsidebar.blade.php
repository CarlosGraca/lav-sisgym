...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            ...
            <h3 class="control-sidebar-heading">{{ trans('adminlte_lang::message.help') }}</h3>
            <ul class='control-sidebar-menu'>
                <li>
                    <a href='javascript::;'>                        
                         <h4 class="control-sidebar-subheading">{{ trans('adminlte_lang::message.quick_start') }}</h4>
                    </a>
                </li>
                <li>
                    <a href='javascript::;'>                        
                         <h4 class="control-sidebar-subheading">{{ trans('adminlte_lang::message.help_features') }}</h4>
                    </a>
                </li>
                <li>
                    <a href='javascript::;'>                        
                         <h4 class="control-sidebar-subheading">{{ trans('adminlte_lang::message.keyboard_shortcuts') }}</h4>
                    </a>
                </li>
                <li>
                    <a href='javascript::;'>                        
                         <h4 class="control-sidebar-subheading">{{ trans('adminlte_lang::message.contact_support') }}</h4>
                    </a>
                </li>
            </ul><!-- /.control-sidebar-menu -->
        </div><!-- /.tab-pane -->
