...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg">{{ trans('adminlte_lang::message.app_name') }}</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <li><a href="#">{{ trans('adminlte_lang::message.upgrade') }}</a></li>
                 ...
                 @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- Menu Body -->
                            <li class="user-body">
                                <a href="{{ url('user/profile') }}"><i class="fa fa-user"></i>{{ trans('adminlte_lang::message.profile') }}</a>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#">
                                    <i class="fa fa-lock"></i> {{ trans('adminlte_lang::message.lock') }}</a>
                                </div>
